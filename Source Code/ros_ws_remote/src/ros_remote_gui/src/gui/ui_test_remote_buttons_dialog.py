...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.verticalLayoutWidget_3 = QWidget(self.mainFrame)
        self.verticalLayoutWidget_3.setObjectName(u"verticalLayoutWidget_3")
        self.verticalLayoutWidget_3.setGeometry(QRect(12, 12, 351, 351))
        self.rightSectionBox = QVBoxLayout(self.verticalLayoutWidget_3)
        ...
        self.rightKeySwitchIndicator = QLabel(self.verticalLayoutWidget_3)
        ...
        self.rightSwitchIndicator_4 = QLabel(self.verticalLayoutWidget_3)
        ...
        self.rightButtonIndicator_4 = QLabel(self.verticalLayoutWidget_3)
        ...
        self.rightButtonIndicator_5 = QLabel(self.verticalLayoutWidget_3)
        ...
        self.rightSwitchIndicator_1 = QLabel(self.verticalLayoutWidget_3)
        ...
        self.rightSwitchIndicator_2 = QLabel(self.verticalLayoutWidget_3)
        ...
        self.rightSwitchIndicator_3 = QLabel(self.verticalLayoutWidget_3)
        ...
        self.rightSectionBox.addItem(self.verticalSpacer_2)

        self.rightButtonIndicator_3 = QLabel(self.verticalLayoutWidget_3)
        ...
        self.encoderLabel = QLabel(self.verticalLayoutWidget_3)
        ...
        self.encoderValue = QLineEdit(self.verticalLayoutWidget_3)
        ...
        self.rightInnerBox_1.addItem(self.horizontalSpacer)

        self.rightButtonIndicator_1 = QLabel(self.verticalLayoutWidget_3)
        ...
        self.rightButtonIndicator_2 = QLabel(self.verticalLayoutWidget_3)
        ...
        self.verticalLayoutWidget = QWidget(self.mainFrame)
        self.verticalLayoutWidget.setObjectName(u"verticalLayoutWidget")
        self.verticalLayoutWidget.setGeometry(QRect(388, 12, 351, 351))
        self.leftSectionBox = QVBoxLayout(self.verticalLayoutWidget)
        ...
        self.eStopIndicator = QLabel(self.verticalLayoutWidget)
        ...
        self.leftSwitchIndicator = QLabel(self.verticalLayoutWidget)
        ...
        self.leftSectionBox.addItem(self.verticalSpacer)
        ...
        self.potentiometerLabel = QLabel(self.verticalLayoutWidget)
        ...
        self.potentiometerValue = QLineEdit(self.verticalLayoutWidget)
        ...
        self.leftButtonIndicator = QLabel(self.verticalLayoutWidget)
