...
#define BUTTONS_INPUT_REPORT_ID   0x02
#define SWITCHES_INPUT_REPORT_ID  0x03
#define LED_OUTPUT_REPORT_ID      0x04
#define INPUT_POLL_REPORT_ID      0x05

// Input (joystick axes) report (ID: 0x01, 9 bytes)
typedef struct {
    int16_t x;      // -512-512
    int16_t y;      // -512-512
    int16_t rz;     // -512-512
...
static const uint8_t hid_report_desc[] = {
    ...
    0xA1, 0x01,            
        ...
        0x85, INPUT_POLL_REPORT_ID,   // Report ID 0x05: Input data poll request
